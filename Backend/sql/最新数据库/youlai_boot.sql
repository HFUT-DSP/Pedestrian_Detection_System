...
CREATE TABLE `camera`  (
  ...
  `camera_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '名称',
  `camera_r_t_s_p` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '地址',
  ...
  `is_deleted` tinyint(0) NOT NULL DEFAULT 0 COMMENT '逻辑删除标识(1-已删除 0-未删除)',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `camera_name`(`camera_name`) USING BTREE COMMENT '部门编号唯一索引'
) ENGINE = InnoDB AUTO_INCREMENT = 131 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '菜单管理' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of camera
-- ----------------------------
INSERT INTO `camera` VALUES (1, '摄像头1', 'rtsp://admin:1111111a@114.213.211.99/Streaming/Channels/101', 1, NULL, NULL, '2021-08-28 09:12:21', '2024-06-24 23:49:04', 0);
INSERT INTO `camera` VALUES (2, '摄像头2', 'rtsp://admin:1111111a@114.213.211.99/Streaming/Channels/105', 1, NULL, NULL, '2021-08-28 09:12:21', '2024-07-18 14:27:12', 0);
...
CREATE TABLE `sys_dept`  (
  ...
  `sort` smallint(0) NULL DEFAULT 0 COMMENT '显示顺序',
  `status` tinyint(0) NOT NULL DEFAULT 1 COMMENT '状态(1-正常 0-禁用)',
  `create_by` bigint(0) NULL DEFAULT NULL COMMENT '创建人ID',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` bigint(0) NULL DEFAULT NULL COMMENT '修改人ID',
...
CREATE TABLE `sys_dict`  (
  ...
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  `is_deleted` tinyint(0) NULL DEFAULT 0 COMMENT '是否删除(1-删除，0-未删除)',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `sys_log`  (
  ...
  `is_deleted` tinyint(0) NOT NULL DEFAULT 0 COMMENT '逻辑删除标识(1-已删除 0-未删除)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 705 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统日志表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_log` VALUES (705, 'LOGIN', '登录', '/api/v1/auth/login', '192.168.145.1', '0', '内网IP', 643, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:04:10', 0);
INSERT INTO `sys_log` VALUES (706, 'USER', '设备管理分页列表', '/api/v1/cameras/page', '192.168.145.1', '0', '内网IP', 16, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:04:18', 0);
INSERT INTO `sys_log` VALUES (707, 'USER', '设备管理分页列表', '/api/v1/cameras/page', '192.168.145.1', '0', '内网IP', 13, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:04:25', 0);
INSERT INTO `sys_log` VALUES (708, 'USER', '设备管理分页列表', '/api/v1/cameras/page', '192.168.145.1', '0', '内网IP', 11, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:04:28', 0);
INSERT INTO `sys_log` VALUES (709, 'USER', '设备管理分页列表', '/api/v1/cameras/page', '192.168.145.1', '0', '内网IP', 9, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:04:33', 0);
INSERT INTO `sys_log` VALUES (710, 'USER', '设备管理分页列表', '/api/v1/cameras/page', '192.168.145.1', '0', '内网IP', 9, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:04:38', 0);
INSERT INTO `sys_log` VALUES (711, 'USER', '设备管理分页列表', '/api/v1/cameras/page', '192.168.145.1', '0', '内网IP', 9, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:04:48', 0);
INSERT INTO `sys_log` VALUES (712, 'USER', '设备管理分页列表', '/api/v1/cameras/page', '192.168.145.1', '0', '内网IP', 8, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:04:51', 0);
INSERT INTO `sys_log` VALUES (713, 'USER', '设备管理分页列表', '/api/v1/cameras/page', '192.168.145.1', '0', '内网IP', 12, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:04:54', 0);
INSERT INTO `sys_log` VALUES (714, 'USER', '设备管理分页列表', '/api/v1/cameras/page', '192.168.145.1', '0', '内网IP', 9, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:05:05', 0);
INSERT INTO `sys_log` VALUES (715, 'USER', '用户分页列表', '/api/v1/users/page', '192.168.145.1', '0', '内网IP', 23, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:05:24', 0);
INSERT INTO `sys_log` VALUES (716, 'MENU', '菜单列表', '/api/v1/menus', '192.168.145.1', '0', '内网IP', 26, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:06:15', 0);
INSERT INTO `sys_log` VALUES (717, 'USER', '用户分页列表', '/api/v1/users/page', '192.168.145.1', '0', '内网IP', 20, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:08:40', 0);
INSERT INTO `sys_log` VALUES (718, 'USER', '用户分页列表', '/api/v1/users/page', '192.168.145.1', '0', '内网IP', 25, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:08:45', 0);
INSERT INTO `sys_log` VALUES (719, 'USER', '用户分页列表', '/api/v1/users/page', '192.168.145.1', '0', '内网IP', 19, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:08:47', 0);
INSERT INTO `sys_log` VALUES (720, 'USER', '用户分页列表', '/api/v1/users/page', '192.168.145.1', '0', '内网IP', 19, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:08:52', 0);
INSERT INTO `sys_log` VALUES (721, 'USER', '用户分页列表', '/api/v1/users/page', '192.168.145.1', '0', '内网IP', 19, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:09:52', 0);
INSERT INTO `sys_log` VALUES (722, 'USER', '用户分页列表', '/api/v1/users/page', '192.168.145.1', '0', '内网IP', 18, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:10:32', 0);
INSERT INTO `sys_log` VALUES (723, 'USER', '用户分页列表', '/api/v1/users/page', '192.168.145.1', '0', '内网IP', 40, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:14:06', 0);
INSERT INTO `sys_log` VALUES (724, 'USER', '设备管理分页列表', '/api/v1/cameras/page', '192.168.145.1', '0', '内网IP', 9, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:14:10', 0);
INSERT INTO `sys_log` VALUES (725, 'USER', '设备管理分页列表', '/api/v1/cameras/page', '192.168.145.1', '0', '内网IP', 9, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:14:14', 0);
INSERT INTO `sys_log` VALUES (726, 'USER', '用户分页列表', '/api/v1/users/page', '192.168.145.1', '0', '内网IP', 20, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:14:19', 0);
INSERT INTO `sys_log` VALUES (727, 'USER', '用户分页列表', '/api/v1/users/page', '192.168.145.1', '0', '内网IP', 21, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:14:22', 0);
INSERT INTO `sys_log` VALUES (728, 'USER', '用户分页列表', '/api/v1/users/page', '192.168.145.1', '0', '内网IP', 22, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:14:24', 0);
INSERT INTO `sys_log` VALUES (729, 'USER', '用户分页列表', '/api/v1/users/page', '192.168.145.1', '0', '内网IP', 19, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:14:28', 0);
INSERT INTO `sys_log` VALUES (730, 'USER', '设备管理分页列表', '/api/v1/cameras/page', '192.168.145.1', '0', '内网IP', 8, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:15:14', 0);
INSERT INTO `sys_log` VALUES (731, 'USER', '用户分页列表', '/api/v1/users/page', '192.168.145.1', '0', '内网IP', 41, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:18:35', 0);
INSERT INTO `sys_log` VALUES (732, 'USER', '设备管理分页列表', '/api/v1/cameras/page', '192.168.145.1', '0', '内网IP', 10, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:18:36', 0);
INSERT INTO `sys_log` VALUES (733, 'USER', '设备管理分页列表', '/api/v1/cameras/page', '192.168.145.1', '0', '内网IP', 19, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:21:24', 0);
INSERT INTO `sys_log` VALUES (734, 'USER', '设备管理分页列表', '/api/v1/cameras/page', '192.168.145.1', '0', '内网IP', 15, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:21:27', 0);
INSERT INTO `sys_log` VALUES (735, 'USER', '设备管理分页列表', '/api/v1/cameras/page', '192.168.145.1', '0', '内网IP', 8, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:21:31', 0);
INSERT INTO `sys_log` VALUES (736, 'USER', '设备管理分页列表', '/api/v1/cameras/page', '192.168.145.1', '0', '内网IP', 9, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:21:40', 0);
INSERT INTO `sys_log` VALUES (737, 'USER', '设备管理分页列表', '/api/v1/cameras/page', '192.168.145.1', '0', '内网IP', 15, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:21:52', 0);
INSERT INTO `sys_log` VALUES (738, 'USER', '设备管理分页列表', '/api/v1/cameras/page', '192.168.145.1', '0', '内网IP', 8, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:21:56', 0);
INSERT INTO `sys_log` VALUES (739, 'USER', '设备管理分页列表', '/api/v1/cameras/page', '192.168.145.1', '0', '内网IP', 9, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:22:00', 0);
INSERT INTO `sys_log` VALUES (740, 'USER', '设备管理分页列表', '/api/v1/cameras/page', '192.168.145.1', '0', '内网IP', 8, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:23:33', 0);
INSERT INTO `sys_log` VALUES (741, 'LOGIN', '登录', '/api/v1/auth/login', '192.168.145.1', '0', '内网IP', 666, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:26:53', 0);
INSERT INTO `sys_log` VALUES (742, 'USER', '设备管理分页列表', '/api/v1/cameras/page', '192.168.145.1', '0', '内网IP', 22, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:26:54', 0);
INSERT INTO `sys_log` VALUES (743, 'USER', '设备管理分页列表', '/api/v1/cameras/page', '192.168.145.1', '0', '内网IP', 8, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:27:01', 0);
INSERT INTO `sys_log` VALUES (744, 'USER', '设备管理分页列表', '/api/v1/cameras/page', '192.168.145.1', '0', '内网IP', 9, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:27:04', 0);
INSERT INTO `sys_log` VALUES (745, 'USER', '设备管理分页列表', '/api/v1/cameras/page', '192.168.145.1', '0', '内网IP', 10, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:27:12', 0);
INSERT INTO `sys_log` VALUES (746, 'USER', '设备管理分页列表', '/api/v1/cameras/page', '192.168.145.1', '0', '内网IP', 9, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:27:21', 0);
INSERT INTO `sys_log` VALUES (747, 'USER', '设备管理分页列表', '/api/v1/cameras/page', '192.168.145.1', '0', '内网IP', 8, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:27:27', 0);
INSERT INTO `sys_log` VALUES (748, 'USER', '设备管理分页列表', '/api/v1/cameras/page', '192.168.145.1', '0', '内网IP', 14, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:27:29', 0);
INSERT INTO `sys_log` VALUES (749, 'USER', '用户分页列表', '/api/v1/users/page', '192.168.145.1', '0', '内网IP', 27, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:27:35', 0);
INSERT INTO `sys_log` VALUES (750, 'USER', '用户分页列表', '/api/v1/users/page', '192.168.145.1', '0', '内网IP', 19, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:27:37', 0);
INSERT INTO `sys_log` VALUES (751, 'USER', '用户分页列表', '/api/v1/users/page', '192.168.145.1', '0', '内网IP', 21, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:27:40', 0);
INSERT INTO `sys_log` VALUES (752, 'USER', '用户分页列表', '/api/v1/users/page', '192.168.145.1', '0', '内网IP', 17, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:27:42', 0);
INSERT INTO `sys_log` VALUES (753, 'USER', '用户分页列表', '/api/v1/users/page', '192.168.145.1', '0', '内网IP', 24, 'MSEdge', '126.0.0.0', 'Windows 10 or Windows Server 2016', 2, '2024-07-18 14:27:45', 0);
...
CREATE TABLE `sys_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 137 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '菜单管理' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_role`  (
  ...
  `data_scope` tinyint(0) NULL DEFAULT NULL COMMENT '数据权限(0-所有数据 1-部门及子部门数据 2-本部门数据3-本人数据)',
  `create_by` bigint(0) NULL DEFAULT NULL COMMENT '创建人 ID',
...
) ENGINE = InnoDB AUTO_INCREMENT = 305 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户信息表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_user_role` VALUES (306, 128);
